      ...
      <div className="overflow-x-auto">
        <table className="min-w-full">
          ...
          <tbody>
            {classes.length === 0 ? (
              <tr>
                <td colSpan="6" className="py-4 text-center text-gray-500">No classes scheduled for today</td>
              </tr>
            ) : (
              classes.map((cls) => (
                <tr key={cls.schedule_id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-2 px-4">{formatTime(cls.start_time)} - {formatTime(cls.end_time)}</td>
                  <td className="py-2 px-4">Room {cls.room_id}</td>
