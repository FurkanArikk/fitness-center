...
import TrainerActivityChart from "@/components/classes/TrainerActivityChart";
...
const Trainers = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Trainer Activity">
        <TrainerActivityChart trainers={trainers} schedules={schedules} />
      </Card>
    </div>
  );
};
